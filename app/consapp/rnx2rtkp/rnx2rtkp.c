...
{
    prcopt_t prcopt=prcopt_default;         // 计算选项设置，设置一个默认值，默认值仅设置了少部分字段
    solopt_t solopt=solopt_default;         // 结果选项
    filopt_t filopt={""};                   // 文件选项
    gtime_t ts={0},te={0};
    ...
    prcopt.navsys=0;
    prcopt.refpos=POSOPT_SINGLE;            // 基准坐标从何处获取（设置文件中输入）
    ...
    // argc 单点定位
    //argc = 5;
    //argv[0] = "C:\\Users\\飞飞\\Desktop\\RTKLIB-b34j\\app\\consapp\\rnx2rtkp\\msc\\Release\\rnx2rtkp.exe";  // 可执行程序
    //argv[1] = "-k";
    //argv[2] = "C:\\Users\\飞飞\\Desktop\\curtin_data\\spp.conf";
    //argv[3] = "C:\\Users\\飞飞\\Desktop\\curtin_data\\CUT2.22o";
    //argv[4] = "C:\\Users\\飞飞\\Desktop\\curtin_data\\CUT2.22n";
 
    //outfile = "C:\\Users\\飞飞\\Desktop\\rtkpos\\8.2\\8.15.pos";

    // RTK
    argc = 6;
    argv[0] = "C:\\Users\\飞飞\\Desktop\\RTKLIB-b34j\\app\\consapp\\rnx2rtkp\\msc\\Release\\rnx2rtkp.exe";  // 可执行程序
    argv[1] = "-k";
    argv[2] = "C:\\Users\\飞飞\\Desktop\\Test\\8.8\\rtk.conf";

    argv[3] = "C:\\Users\\飞飞\\Desktop\\Test\\8.8\\ROVER\\8.obs";
    argv[4] = "C:\\Users\\飞飞\\Desktop\\Test\\8.8\\BASE\\470.obs";
    argv[5] = "C:\\Users\\飞飞\\Desktop\\Test\\8.8\\BRDM00DLR_S_20242210000_01D_MN.rnx";

    outfile = "C:\\Users\\飞飞\\Desktop\\Test\\8.8\\rtk.pos";

    /* load options from configuration file */
    // 从配置文件读取选项参数，后续有必要可以精简一下
    for (i=1;i<argc;i++) {
        if (!strcmp(argv[i],"-k")&&i+1<argc) {
            resetsysopts();
            if (!loadopts(argv[++i],sysopts)) return EXIT_FAILURE;  //argv[++i];文件路径  sysopts；结构体数组。读取定位参数设置，用prcopt_ 修改了prcopt
